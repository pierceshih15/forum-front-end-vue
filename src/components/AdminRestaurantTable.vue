    ...
    <tbody>
      ...
      >
        ...
        <td class="d-flex justify-content-between">
          <router-link 
           :to="{name:'admin-restaurant', params:{id:restaurant.id}}" class="btn btn-link">
           Show
          </router-link>

          <router-link 
           :to="{name:'admin-restaurant-edit', params:{id:restaurant.id}}" class="btn btn-link">
          Edit
          </router-link>

          <button
            type="button"
            class="btn btn-link" @click.stop.prevent="deleteRestaurant(restaurant.id)"
          >
            Delete
          </button>
        </td>
...
const dummyData = {
    "restaurants": [
        ...
        },
        {
            ...
            "viewCounts": 11,
            "createdAt": "2019-07-30T16:24:55.434Z",
            "updatedAt": "2019-08-06T23:47:08.130Z",
            "CategoryId": 1,
            "Category": {
                "id": 1,
                "name": "中式料理",
        ...
        },
        {
            ...
            "updatedAt": "2019-08-08T01:56:16.426Z",
            "CategoryId": 3,
            "Category": {
                "id": 3,
                "name": "義大利料理",
        ...
        },
        {
            ...
            "viewCounts": 2,
            "createdAt": "2019-07-30T16:24:55.437Z",
            "updatedAt": "2019-08-04T17:30:37.772Z",
            "CategoryId": 2,
            "Category": {
                "id": 2,
                "name": "日本料理",
        ...
        },
        {
            ...
            "viewCounts": 2,
            "createdAt": "2019-07-30T16:24:55.439Z",
            "updatedAt": "2019-08-06T23:46:58.706Z",
            "CategoryId": 1,
            "Category": {
                "id": 1,
                "name": "中式料理",
        ...
        },
        {
            ...
            "viewCounts": 17,
            "createdAt": "2019-07-30T16:24:55.438Z",
            "updatedAt": "2019-08-06T23:46:46.297Z",
            "CategoryId": 1,
            "Category": {
                "id": 1,
                "name": "中式料理",
        ...
        },
        {
            ...
            "viewCounts": 18,
            "createdAt": "2019-07-30T16:24:55.440Z",
            "updatedAt": "2019-08-07T08:32:07.195Z",
            "CategoryId": 1,
            "Category": {
                "id": 1,
                "name": "中式料理",
        ...
        },
        {
            ...
            "viewCounts": 5,
            "createdAt": "2019-07-30T16:24:55.441Z",
            "updatedAt": "2019-08-06T23:48:11.382Z",
            "CategoryId": 2,
            "Category": {
                "id": 2,
                "name": "日本料理",
        ...
        },
        {
            ...
            "viewCounts": 7,
            "createdAt": "2019-07-30T16:24:55.438Z",
            "updatedAt": "2019-08-07T08:21:42.296Z",
            "CategoryId": 1,
            "Category": {
                "id": 1,
                "name": "中式料理",
        ...
        },
        {
            ...
            "viewCounts": 3,
            "createdAt": "2019-07-30T16:24:55.440Z",
            "updatedAt": "2019-08-07T04:42:26.545Z",
            "CategoryId": 3,
            "Category": {
                "id": 3,
                "name": "義大利料理",
